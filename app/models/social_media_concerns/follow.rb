module SocialMediaConcerns
  class Follow < ApplicationRecord
    include SocialMediaConcerns::SocialMediaConcernsHelper
    ...
    def raise_already_followd_error_if_required
      raise SocialMediaConcerns::Follows::AlreadyExistsError.new("#{owner_type} has already followed that #{target_type}") if owner.followable_objects.exists?(target: target)
    end
  end
end
