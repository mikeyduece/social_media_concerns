...
ActiveRecord::Schema.define(version: 2020_06_04_220945) do
  ...
  create_table "social_media_blocks", force: :cascade do |t|
    ...
    t.index ["owner_type", "owner_id"], name: "index_social_media_blocks_on_owner_type_and_owner_id"
    t.index ["target_id", "target_type", "owner_id", "owner_type"], name: "idx_social_media_blocks_on_owner_and_target", unique: true
    t.index ["target_type", "target_id"], name: "index_social_media_blocks_on_target_type_and_target_id"
  end

  create_table "social_media_follows", force: :cascade do |t|
    t.string "target_type"
    t.integer "target_id"
    t.string "owner_type"
    t.integer "owner_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["owner_type", "owner_id"], name: "index_social_media_follows_on_owner_type_and_owner_id"
    t.index ["target_id", "target_type", "owner_id", "owner_type"], name: "idx_social_media_follows_on_owner_and_target", unique: true
    t.index ["target_type", "target_id"], name: "index_social_media_follows_on_target_type_and_target_id"
  end

  create_table "social_media_likes", force: :cascade do |t|
    t.string "owner_type"
    t.integer "owner_id"
    t.string "target_type"
    t.integer "target_id"
